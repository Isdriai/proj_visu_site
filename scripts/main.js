...
// TODO général: mettre un theme, recentrer les div, ne garder que les secteurs/acteurs publics/privés les plus présents comme pour l'état initial du sankey
// débuguer la variable globale "dict" (ligne 47), "var" a été oublié mais le fait de le mettre nécessite quelques modifications notamment dans 1-preproc.js
(function (d3) {
  ...
  var [idSankey, idBars, idProvince, idHistosPriv, idHistosPub] = ["sankey", "barCharts", "barProvince", "histosPriv", "histosPub"] // voir index.html
